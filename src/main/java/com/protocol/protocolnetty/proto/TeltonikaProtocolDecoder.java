...
public class TeltonikaProtocolDecoder extends ChannelInboundHandlerAdapter {
    ...
    private String path;
    private final boolean connectionless=true;
...
//   protected void init() {
//       this.extended = getConfig().getBoolean(Keys.PROTOCOL_EXTENDED.withPrefix("Teltonika"));
//    }
    ...
    private List<Position> parseData(
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (codec == CODEC_13) {
                ...
                decodeSerial(channel, remoteAddress, null, null, buf);
            } else {
                decodeLocation(null, buf, codec, null);
            }
